...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/motorola-hardware-sensorscalibrate.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/motorola-hardware-sensorscalibrate.xml \
...
$(call inherit-product, vendor/motorola/ellis/ellis-vendor.mk)
